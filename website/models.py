...
class Case_Material(TranslatableModel):
    translations = TranslatedFields(name=models.CharField(_("Name"), max_length=150))
...
class Product(TranslatableModel):
    ...
    material = models.ManyToManyField(
        Case_Material,
        verbose_name=_("Case_Material"),
        related_name=_("Products"),
        blank=True,
    )
    surface_finish = models.ManyToManyField(
        Surface_Finish,
        verbose_name=_("Surface_Finishes"),
        related_name=_("Products"),
        blank=True,
    )
    ...
    color = models.ManyToManyField(
        Color, verbose_name=_("Color"), related_name=_("Products"), blank=True
    )
...
class Blog(TranslatableModel):
    ...
    category = models.ManyToManyField(
        Blog_Cates, verbose_name=_("Category"), related_name=_("Blog"), blank=True
    )
